...
export const Messages = () => {
  ...
  const fetchData = async () => {
    const response = await fetch(
      `http://localhost:8080/get_messages/${conversationId}`
    );
  ...
  return (
    <>
      ...
      <div className="input-container">
        {!conversationId && (
          <p className="note">
            Please create a new chat before asking questions to the chatbot.
          </p>
        )}
        <div className="input">
          <input
          ...
          />
          <div className="send">
            <button onClick={handleAddNewChat} disabled={sending || !conversationId}>
